  ...
  template: `
    @if (open()) {
      <div class="fixed inset-0 z-50 flex items-center justify-center">
        ...
        <div class="relative bg-surface border border-token shadow-xl w-full mx-4 max-w-full sm:max-w-[420px] md:max-w-[640px] lg:max-w-[800px] xl:max-w-[960px] 2xl:max-w-[1100px] max-h-[calc(100dvh-2rem)] sm:max-h-[calc(100dvh-4rem)] flex flex-col overflow-y-auto">
          @if (title()) {
