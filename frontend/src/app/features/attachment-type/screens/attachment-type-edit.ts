...
@Component({
  selector: 'app-attachment-type-edit-page',
  standalone: true,
  imports: [CommonModule, AttachmentTypeFormComponent, ActionBarComponent, CardComponent, SpinnerComponent],
  template: `
    <app-action-bar
      [showEdit]="false"
      [showNew]="false"
...
export class AttachmentTypeEditPage {
