...
public final class ClaimMessageView {
    public static final String CLAIM_CREATED_SUCCESSFULLY = "claim.created";
    public static final String CLAIM_DELETED_SUCCESSFULLY = "claim.deleted";
