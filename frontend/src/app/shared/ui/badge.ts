...
export type BadgeTone = 'info' | 'success' | 'warn' | 'neutral' | 'danger';
...
@Component({
  ...
  template: `
    <span [ngClass]="{
        ...
        'bg-red-100 text-red-800 dark:bg-red-900 dark:text-red-100': tone() === 'danger',
        'bg-yellow-100 text-yellow-800 dark:bg-yellow-900 dark:text-yellow-100': tone() === 'warn',
